...
class JodDecoration extends GameDecoration with Sensor {
  bool dialogFinished = false;

  JodDecoration(Vector2 position)
      : super.withSprite(
    sprite: Sprite.load('objects/Jod.png'), // Assuming the sprite is named 'Gadolinium.png'
    position: position,
  ...
  void onContact(GameComponent component) {
    ...
    if (component is PlayerSerife) {
      ...
      component.collectibles.add(kJodCollectible); // Assuming kGadoliniumCollectible is defined
              ...
              child: Column(
                ...
                children: <Widget>[
                  Row(
                    children: [
                      Image.asset(
                        'assets/images/objects/Jod-200.png', // Assuming this image exists
                        width: 50,
                        height: 50,
                      ),
                        ...
                        child: Text.rich(
                          TextSpan(
                            children: [
                              ...
                              TextSpan(
                                text: 'ein jodhaltiges Kontrastmittel',
