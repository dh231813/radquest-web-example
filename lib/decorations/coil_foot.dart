...
class FootCoilDecoration extends GameDecoration with Sensor {
  bool dialogFinished = false;

  FootCoilDecoration(Vector2 position)
      : super.withSprite(
    sprite: Sprite.load('objects/CoilFoot.png'), // Assuming the sprite is named 'CoilFoot.png'
    position: position,
  ...
  void onContact(GameComponent component) {
    ...
    if (component is PlayerSerife) {
      ...
      component.collectibles.add(kFootCoilCollectible); // Assuming kFootCoilCollectible is defined
              ...
              child: Column(
                ...
                children: <Widget>[
                  Row(
                    children: [
                      Image.asset(
                        'assets/images/objects/CoilFoot-large.png', // Assuming this image exists
                        width: 150,
                        height: 150,
                      ),
                        ...
                        child: Text.rich(
                          TextSpan(
                            children: [
                              ...
                              TextSpan(
                                text: ' gefunden. Diese spezielle Spule wird bei MRT-Untersuchungen des Fußes verwendet. Sie bietet eine hohe Bildqualität und präzise Detailgenauigkeit für die Diagnose von Fußproblemen. Die Fußspule ist speziell geformt, um sich optimal an die Anatomie des Fußes anzupassen und die bestmöglichen Ergebnisse zu liefern.',
                                style: TextStyle(color: Colors.white, fontSize: 22),
                              ),
                            ],
                          ),
