...
class DoctorCT extends SimpleEnemy with BlockMovementCollision, Sensor {
  ...
  void _showQuizDialog(BuildContext context, PlayerBeardedDude player) {
                  ...
                  Row(
                    children: [
                      SizedBox(
                        width: 50,
                        height: 50,
                        child: DoctorCTSpriteSheet.idleFrontSingleFrame.asWidget(),
                      ),
  ...
  List<Widget> _buildAnswerButtons(BuildContext context, PlayerBeardedDude player) {
    List<Widget> buttons = [];
  ...
  Widget _buildAnswerButton(BuildContext context, PlayerBeardedDude player, String answerText, bool isCorrect) {
    return TextButton(
  ...
  void _showFeedbackDialog(BuildContext context, PlayerBeardedDude player, bool isCorrect) {
  ...
  void _showFinalResultDialog(BuildContext context, PlayerBeardedDude player) {
    showDialog(
      context: context,
      builder: (BuildContext context) {
        return Dialog(
